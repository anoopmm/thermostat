...
function(i) {
    ...
    i.run(["$templateCache", function(i) {
        i.put("ionic-timepicker.html", '<div><div class=heading>Start {{time.hours}} : {{time.minutes}} <span ng-show="time.format == 12">{{time.meridian}}</span></div><div class=row ng-class="{\'padding_left_15px\':time.format == 12}"><div class="col col-25" ng-class="{\'col-offset-20 col-25\':time.format == 24}"><button type=button class="button button-clear button-small button-dark time_picker_arrows" ng-click=increaseHours()><i class="icon ion-chevron-up"></i></button><div ng-bind=time.hours class=time_picker_box_text></div><button type=button class="button button-clear button-small button-dark time_picker_arrows" ng-click=decreaseHours()><i class="icon ion-chevron-down"></i></button></div><label class="col col-10 time_picker_colon">:</label><div class="col col-25" ng-class="{\'col-25\':time.format == 24}"><button type=button class="button button-clear button-small button-dark time_picker_arrows" ng-click=increaseMinutes()><i class="icon ion-chevron-up"></i></button><div ng-bind=time.minutes class=time_picker_box_text></div><button type=button class="button button-clear button-small button-dark time_picker_arrows" ng-click=decreaseMinutes()><i class="icon ion-chevron-down"></i></button></div><label class="col col-10 time_picker_colon" ng-if="time.format == 12">:</label><div class="col col-25" ng-if="time.format == 12"><button type=button class="button button-clear button-small button-dark time_picker_arrows" ng-click=changeMeridian()><i class="icon ion-chevron-up"></i></button><div ng-bind=time.meridian class=time_picker_box_text></div><button type=button class="button button-clear button-small button-dark time_picker_arrows" ng-click=changeMeridian()><i class="icon ion-chevron-down"></i></button></div></div></div><div><div class=heading>End {{time.hours2}} : {{time.minutes2}} <span ng-show="time.format == 12">{{time.meridian}}</span></div><div class=row ng-class="{\'padding_left_15px\':time.format == 12}"><div class="col col-25" ng-class="{\'col-offset-20 col-25\':time.format == 24}"><button type=button class="button button-clear button-small button-dark time_picker_arrows" ng-click=increaseHours2()><i class="icon ion-chevron-up"></i></button><div ng-bind=time.hours2 class=time_picker_box_text></div><button type=button class="button button-clear button-small button-dark time_picker_arrows" ng-click=decreaseHours2()><i class="icon ion-chevron-down"></i></button></div><label class="col col-10 time_picker_colon">:</label><div class="col col-25" ng-class="{\'col-25\':time.format == 24}"><button type=button class="button button-clear button-small button-dark time_picker_arrows" ng-click=increaseMinutes2()><i class="icon ion-chevron-up"></i></button><div ng-bind=time.minutes2 class=time_picker_box_text></div><button type=button class="button button-clear button-small button-dark time_picker_arrows" ng-click=decreaseMinutes2()><i class="icon ion-chevron-down"></i></button></div><label class="col col-10 time_picker_colon" ng-if="time.format == 12">:</label><div class="col col-25" ng-if="time.format == 12"><button type=button class="button button-clear button-small button-dark time_picker_arrows" ng-click=changeMeridian()><i class="icon ion-chevron-up"></i></button><div ng-bind=time2.meridian class=time_picker_box_text></div><button type=button class="button button-clear button-small button-dark time_picker_arrows" ng-click=changeMeridian()><i class="icon ion-chevron-down"></i></button></div></div><label class="item item-input"><input type="number" ng-min="15" placeholder="First Name" ng-model="time.tempValue"></label></div>')
    ...
    this.configTimePicker = function(e) {
        ...
        function o(i, e) {
            ...
            r.time.hours2 = Math.floor(i / 3600);
            r.time.minutes2 = "00";
            var t = i % 3600;
        ...
        return r.today = n(new Date).getTime(), r.time = {}, r.increaseHours = function() {
        ...
        }, r.increaseHours2 = function() {
            r.time.hours2 = Number(r.time.hours2), 12 == r.mainObj.format && (12 != r.time.hours2 ? r.time.hours2 += 1 : r.time.hours2 = 1), 24 == r.mainObj.format && (r.time.hours2 = (r.time.hours2 + 1) % 24), r.time.hours2 = r.time.hours2 < 10 ? "0" + r.time.hours2 : r.time.hours2
        }, r.decreaseHours2 = function() {
            r.time.hours2 = Number(r.time.hours2), 12 == r.mainObj.format && (r.time.hours2 > 1 ? r.time.hours2 -= 1 : r.time.hours2 = 12), 24 == r.mainObj.format && (r.time.hours2 = (r.time.hours2 + 23) % 24), r.time.hours2 = r.time.hours2 < 10 ? "0" + r.time.hours2 : r.time.hours2
        }, r.increaseMinutes2 = function() {
            r.time.minutes2 = Number(r.time.minutes2), r.time.minutes2 = (r.time.minutes2 + r.mainObj.step) % 60, r.time.minutes2 = r.time.minutes2 < 10 ? "0" + r.time.minutes2 : r.time.minutes2
        }, r.decreaseMinutes2 = function() {
            r.time.minutes2 = Number(r.time.minutes2), r.time.minutes2 = (r.time.minutes2 + (60 - r.mainObj.step)) % 60, r.time.minutes2 = r.time.minutes2 < 10 ? "0" + r.time.minutes2 : r.time.minutes2
            ...
            r.mainObj = angular.extend({}, i, e), o(r.mainObj.inputTime, r.mainObj.format), n.push({
                ...
                onTap: function(i) {
                    var e = 0;
                    var f = 0;
                    12 == r.time.format ? (r.time.hours = Number(r.time.hours),
                            "PM" == r.time.meridian && 12 != r.time.hours ? r.time.hours += 12 : "AM" == r.time.meridian && 12 == r.time.hours && (r.time.hours -= 12),
                            e = 60 * r.time.hours * 60 + 60 * r.time.minutes,f = 60 * r.time.hours2 * 60 + 60 * r.time.minutes2) : e = 60 * r.time.hours * 60 + 60 * r.time.minutes,f = 60 * r.time.hours2 * 60 + 60 * r.time.minutes2,
                        r.mainObj.callback(e,f,r.time.tempValue)
                }
            }), n.push({
