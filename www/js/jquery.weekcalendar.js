    ...
    return {
      ...
      _resizeCalendar: function() {
        ...
        if (options && $.isFunction(options.height)) {
          ...
          var scrollContainerHeight = (options.businessHours.end - options.businessHours.start) * 60;
      ...
      _setupEventDelegation: function() {
        ...
        this.element.bind('touchstart click',function(event) {
...
//              calendarHeaderHtml+=    "</div>";
  ...
  TODO    if total height for an hour is less than 11px, there is a display problem.
      ...
      _renderEvent: function(calEvent, $weekDay) {
          ...
          if(calEvent.eventType === "wc-cal-break-event") {
            eventClass += " wc-cal-break-event";
          }
          if(calEvent.eventType === "wc-cal-user-event") {
            eventClass += " wc-cal-user-event";
          }
          eventHtml = '<div class=\"' + eventClass + ' ui-corner-all\">';
          eventHtml += '<div class=\"wc-time ui-corner-top\" style="direction:ltr"></div>';
